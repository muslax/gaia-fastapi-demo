...
def send_email(
    ...
    logging.info(">>> " + __name__ + ":" + send_email.__name__ )
...
def send_test_email(email_to: str):
    logging.info(">>> " + __name__ + ":" + send_test_email.__name__ )
...
def send_reset_password_email(email_to: str, username: str, token: str):
    logging.info(">>> " + __name__ + ":" + send_reset_password_email.__name__ )
    project_name = config.PROJECT_NAME
    ...
    logging.info(">>> email_to: " + username + " <" + email_to + ">")
    logging.info(f"Ready to send email to: {email_to}")
    send_email(
        email_to=email_to,
        subject_template=subject,
        html_template=template_str,
...
def send_new_account_email(email_to: str, username: str, password: str):
    logging.info(">>> " + __name__ + ":" + send_new_account_email.__name__ )
    project_name = config.PROJECT_NAME
...
def generate_password_reset_token(username):
    logging.info(">>> " + __name__ + ":" + generate_password_reset_token.__name__ )
...
def verify_password_reset_token(token) -> Optional[str]:
    logging.info(">>> " + __name__ + ":" + verify_password_reset_token.__name__ )
    try:
